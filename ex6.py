...
dataBase = pd.read_csv("datasets/sales.csv")
# print(dataBase)

# Getting the list of the month_number from the dataFrame by toList() method
x_axis = dataBase['month_number'].to_list()

# Getting the list of the monthly_profit all products from the dataFrame by toList() method
...
# list Of Dictionary also called as Ajacency lists, used to model the Graph Data Structure generally
index = 0
